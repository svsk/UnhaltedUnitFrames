...
local function CreateHealPredictionSettings(containerParent, unit, updateCallback)
    ...
    AbsorbPositionDropdown:SetRelativeWidth(0.5)
    ...
    HealAbsorbPositionDropdown:SetRelativeWidth(0.5)
...
local function CreatePortraitSettings(containerParent, unit, updateCallback)
    ...
    ZoomSlider:SetRelativeWidth(0.25)
    ...
    SizeSlider:SetCallback("OnValueChanged", function(_, _, value) PortraitDB.Size = value updateCallback() end)
